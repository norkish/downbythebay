...
public abstract class W2vOperations {
    ...
    public static W2vModel buildW2vModel(String fileName) {
		System.out.println("Entering buildW2vModel");
        File file;
...
//
//        System.out.println("Performing W2v Analogy: [" + oldSentiment + "] is to [" + newSentiment + "] as [" + oldWord + "] is to ?");
//
...
//
//        System.out.println("\tThe best analogous word was: [" + closest_word + "]");
//
...
//    }
    ...
    public static Map<Double, String> pointToStrings(W2vPoint referencePoint,
        ...
        if (number_of_suggestions_to_show > 1 && !word.equals("NO_WORD_YET"))
            System.out.println("Finding word2vec suggestions similar to [" + word + "]...");
        ...
        for (a = 0; a < number_of_suggestions_to_show; a++) {
            if (a == 0 && number_of_suggestions_to_show > 1)
                System.out.println("word2vec found " + number_of_suggestions_to_show + " filterWords: ");
...
//
//        System.out.println("Summing W2v points: ");
//        int i = 0;
//        for (W2vPoint point : points) {
//            if (i >= nOfPoints - 1)
//                System.out.println("[" + point.getClosestString() + "]");
//            else
//                System.out.println("[" + point.getClosestString() + "], ");
//            i++;
//        }
...
//
//        System.out.println("\tThe summed filterWords gave the word: [" + closest_word + "]");
//
...
////
////        System.out.println("Finding point for " + word + "...");
////
...
////        return new W2vPoint(point, word, new long[] {inputWordVocabPosition}, number_of_input_words);
    ...
    public static Pair<W2vPoint, int[]> stringsToPoint(OperationType type, List<String> strings) throws BadW2vInputException {
        // Grab data from word2vec model
        long numberOfWordsInVector = model.getNumberOfWordsInVector();
        long numberOfDimensionsInVector = model.getNumberOfDimensionsInVector();
        float[] M = model.getM();
    ...
    private static void postPrint(OperationType type, String closest_word) {
        switch (type) {
            case SUM:
                System.out.println("\tThe summed filterWords added up to the word: [" + closest_word + "]");
                break;
            case AVERAGE:
                System.out.println("\tThe averaged filterWords gave the word: [" + closest_word + "]");
                break;
            case ANALOGY:
                System.out.println("\tThe best analogous word was: [" + closest_word + "]");
                break;
            case SINGLE:
                System.out.println("\tFound point for: [" + closest_word + "]...");
                break;
        }
    }
